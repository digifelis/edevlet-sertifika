...
<div class="card card-default">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="{{route('superadmin.kurslar.edit', ['id'=>$kurslar->id])}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="exampleSelectRounded0">Kurs Kurumu</label>
                            <select class="custom-select rounded-0" id="exampleSelectRounded0" name="kursKurumId">
                                <option value="none">seçiniz</option>
                                @foreach ($kurumlar as $kurum)
                                <option value="{{$kurum->id}}" {{$kurslar->kursKurumId == $kurum->id? 'selected':''}} >{{$kurum->kurumAdi}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
